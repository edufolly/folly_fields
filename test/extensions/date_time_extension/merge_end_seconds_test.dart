...
void main() {
  group('DateTimeExtension mergeEndSeconds', () {
    Set<(String, DateTime)> domain = <(String, DateTime)>{
      ...
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEndSeconds(microsecond: 888),
      ),
      (
        '2000-01-01T00:00:22.999',
        DateTime(2000, 1, 1, 0, 0, 11, 111, 111).mergeEndSeconds(second: 22),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEndSeconds(second: 22, microsecond: 888),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEndSeconds(second: 22, millisecond: 222),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEndSeconds(second: 22, millisecond: 222, microsecond: 888),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEndSeconds(millisecond: 222),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEndSeconds(millisecond: 222, microsecond: 888),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 1, 0, 0, 11, 111, 111).mergeEndSeconds(second: 22),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 31, 0, 0, 11, 111, 111).mergeEndSeconds(second: 22),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 31, 23, 0, 11, 111, 111).mergeEndSeconds(second: 22),
      ),
      (
