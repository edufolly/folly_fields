...
void main() {
  group('DateTimeExtension mergeEnd', () {
    Set<(String, DateTime)> domain = <(String, DateTime)>{
      ...
      (
        ...
        DateTime(2000, 1, 1, 11, 11, 11, 111, 111).mergeEnd(microsecond: 888),
      ),
      (
        '2000-01-01T23:59:22.999',
        DateTime(2000, 1, 1, 11, 11, 11, 111, 111).mergeEnd(second: 22),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEnd(second: 22, microsecond: 888),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEnd(second: 22, millisecond: 222),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEnd(second: 22, millisecond: 222, microsecond: 888),
      ),
      (
        '2000-01-01T23:59:59.222',
        DateTime(2000, 1, 1, 11, 11, 11, 111, 111).mergeEnd(millisecond: 222),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEnd(millisecond: 222, microsecond: 888),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 1, 11, 11, 11, 111, 111).mergeEnd(microsecond: 888),
      ),
      (
        '2000-12-01T23:59:22.999',
        DateTime(2000, 12, 1, 11, 11, 11, 111, 111).mergeEnd(second: 22),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 1, 11, 11, 11, 111, 111).mergeEnd(millisecond: 222),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 31, 11, 11, 11, 111, 111).mergeEnd(microsecond: 888),
      ),
      (
        '2000-12-31T23:59:22.999',
        DateTime(2000, 12, 31, 11, 11, 11, 111, 111).mergeEnd(second: 22),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 31, 11, 11, 11, 111, 111).mergeEnd(millisecond: 222),
      ),
      (
      ...
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEnd(time: const TimeOfDay(hour: 22, minute: 22)),
      ),
      (
      ...
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeEnd(time: const TimeOfDay(hour: 22, minute: 22), second: 22),
      ),
      (
    ...
    for (final (String key, DateTime value) in domain) {
      test('Testing $key', () => expect(key, value.toIso8601String()));
    }
  });
}
