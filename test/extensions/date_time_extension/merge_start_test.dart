...
void main() {
  group('DateTimeExtension mergeStart', () {
    Set<(String, DateTime)> domain = <(String, DateTime)>{
      ...
      (
        ...
        DateTime(2000, 1, 1, 11, 11, 11, 111, 111).mergeStart(microsecond: 888),
      ),
      (
        '2000-01-01T00:00:22.000',
        DateTime(2000, 1, 1, 11, 11, 11, 111, 111).mergeStart(second: 22),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(second: 22, microsecond: 888),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(second: 22, millisecond: 222),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(second: 22, millisecond: 222, microsecond: 888),
      ),
      (
        '2000-01-01T00:00:00.222',
        DateTime(2000, 1, 1, 11, 11, 11, 111, 111).mergeStart(millisecond: 222),
      ),
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(millisecond: 222, microsecond: 888),
      ),
      (
      ...
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(microsecond: 888),
      ),
      (
        '2000-12-01T00:00:22.000',
        DateTime(2000, 12, 1, 11, 11, 11, 111, 111).mergeStart(second: 22),
      ),
      (
      ...
      (
        ...
        DateTime(2000, 12, 31, 11, 11, 11, 111, 111).mergeStart(second: 22),
      ),
      (
      ...
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(time: const TimeOfDay(hour: 23, minute: 59)),
      ),
      (
      ...
      (
        ...
        DateTime(
          ...
          111,
          111,
        ).mergeStart(time: const TimeOfDay(hour: 23, minute: 59), second: 22),
      ),
      (
