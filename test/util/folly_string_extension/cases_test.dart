...
import 'package:folly_fields/extensions/folly_string_extension.dart';
...
void main() {
  ...
  for (final (
    ...
    group('Valid: $name', () {
      ...
      test(
        'snake_case is true',
        () => expect(snakeCase.isSnakeCase, true),
      );
  ...
  for (final MapEntry<String, String>(
    ...
    group('Errors: $key', () {
      test(
        'camelCase is false',
        () => expect(value.isCamelCase, false),
      );

      test(
        'PascalCase is false',
        () => expect(value.isPascalCase, false),
      );

      test(
        'snake_case is false',
        () => expect(value.isSnakeCase, false),
      );
